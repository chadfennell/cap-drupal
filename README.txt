...
2. Capistrano Script Setup/Config
...
data into these databases if you have an existing database.  If you do
NOT have an existing database, follow the normal Drupal installation 
instructions once you have completed the rest of these steps.
...
database CONFIGURATION FILE (e.g. db_settings_1.json).

4.3 Link one of these config files (doesn't matcher which one) to your shared/default directory as
